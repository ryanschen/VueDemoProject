<template>
  <div>
    ...
    <scroller lock-y :scrollbar-x=false>
      <div class="box1">
        <div class="box1-item" v-for="i in 7" v-bind:key="i"><span>{{' ' + i + ' '}}</span></div>
      </div>
    </scroller>
    ...
    <scroller lock-x height="200px" @on-scroll="onScroll" ref="scrollerEvent">
      <div class="box2">
        <p v-for="i in 80" v-bind:key="i">placeholder {{i}}</p>
      </div>
    </scroller>
    ...
    <scroller lock-x height="200px" @on-scroll-bottom="onScrollBottom" ref="scrollerBottom" :scroll-bottom-offst="200">
      <div class="box2">
        <p v-for="i in bottomCount" v-bind:key="i">placeholder {{i}}</p>
    ...
    <scroller lock-x scrollbar-y height="200px" ref="scroller">
      <div class="box2">
        <p v-for="i in 20" v-if="showList1" v-bind:key="i">placeholder {{ i + '' + i }}</p>
        <p v-for="i in 10" v-if="!showList1" v-bind:key="i">placeholder {{ i }}</p>
