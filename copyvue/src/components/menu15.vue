<template>
  <div class="menu2-div content-box-shadow">
    ...
    <h5 class="margin-top12-bottom12">用户列表</h5>
    <el-table
      ref="multipleTable"
      :data="tableData"
      v-loading="loading"
      ...
      <el-table-column
	      ...
	      <el-button
	          size="small"
	          type="success"
	          @click="handleEdit(scope.$index, scope.row)">接待记录</el-button>
	        <!-- <el-button
            size="small"
            type="warning"
	...
	<br>
     ...
     <el-dialog title="接待记录" top="8%" :close-on-click-modal="constFalse" :close-on-press-escape="constFalse" :visible.sync="editFormVisible"
     	@open="openEditForm"
